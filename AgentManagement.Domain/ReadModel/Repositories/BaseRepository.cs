...
namespace AgentManagement.Domain.ReadModel.Repositories
{
    public class BaseRepository
    {
        ...
        /// <summary>
        /// The Namespace is the first part of any key created by this Repository, e.g. "location" or "agent"
        /// </summary>
        ...
        public T Get<T>(string keySuffix)
        {
            ...
            if (serializedObject.IsNullOrEmpty) throw new ArgumentNullException(); //Throw a better exception than this.
